...
?>
	<script type="text/javascript">
		opener.document.getElementById("createForm").<?=$_POST['varid']?>.value = '<?=$_FILES['file']['name']?>' + ':' + '<?=$_FILES['file']['tmp_name']."_tmpfile"?>';
		opener.document.getElementById("createForm").<?="n".$_POST['varid']?>.value = '<?=$_FILES['file']['name']?>';
		self.close();
	</script>
	<?
	return;
...
<html>
	...
	<body>
		<form action="upload.php" enctype="multipart/form-data" method="post" name="uploadForm">
