<?
$count = 0;
$templates_override['show_line.php'][$count]['filename'] = "overrides/show_line/show_line-comment.php";
...
$count = 0;
$templates_override['small_line.php'][$count]['filename'] = "overrides/small_line/small_line-link.php";
...
$count = 0;
$templates_override['show_item.php'][$count]['filename'] = "overrides/show_item/show_item-file.php";
$templates_override['show_item.php'][$count]['match']['class'] = "file";

$count++;
$templates_override['show_item.php'][$count]['filename'] = "overrides/show_item/show_item-contact.php";
...
$count = 0;
$templates_override['data_show.php'][$count]['filename'] = "overrides/data_show/data_show-file.php";
$templates_override['data_show.php'][$count]['match']['class'] = "file";

$count++;
$templates_override['data_show.php'][$count]['filename'] = "overrides/data_show/data_show-article.php";
