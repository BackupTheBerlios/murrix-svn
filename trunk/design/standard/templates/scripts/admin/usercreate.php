...
<form name="sUserCreate" id="sUserCreate" action="javascript:void(null);" onsubmit="Post('admin', 'zone_main', 'sUserCreate');">
	...
	<div class="main">
		<?=ucf(i18n("name"))?>: <input class="input" type="text" name="name"/>
		<br/>
		<br/>
		<?=ucf(i18n("username"))?>: <input class="input" type="text" name="username"/>
		<br/>
		<br/>
		<?=ucf(i18n("passowrd"))?>: <input class="input" type="password" name="password1"/> <input class="input" type="password" name="password2"/>
		<br/>
		<br/>
