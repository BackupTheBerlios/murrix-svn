...
The basis for MURRiX is its nodes. All data stored in objects witch are connected to nodes.
...
MURRiX also supports diffrent templates for the possibility of creating a uniqe GUI for a page.
